        ...
        <div class="col-11">
            ...
            <div class="col-12 border border-2 border-dark-subtle mb-3">
                <span class="d-flex"><i class="fs-5 text-secondary bi bi-cash m-2"></i>
                    <input type="text" class="form-control-plaintext" id="amount" name="service_code"
                        placeholder="<?= $transaksiData['service_tariff'] ?>" aria-label="Amount"
                        aria-describedby="addon-wrapping" disabled></span>
            </div>

            <div class="d-grid gap-2">
                <button type="button" class="btn btn-danger btn-lg" id="topUpBtn" data-bs-toggle="modal"
                    data-bs-target="#confirmModal">Top Up</button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h2 class="mb-4" id="displayAmount">Rp
                        <?= number_format($transaksiData['service_tariff'] , 0, ',', '.') ?></h2>
                    ...
                    <a type="button" class="link-offset-2 link-underline link-underline-opacity-0 link-secondary"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h2 class="mb-1" id="displayAmount">Rp
                        <?= number_format($transaksiData['service_tariff'] , 0, ',', '.') ?></h2>
                    <p>berhasil!.</p>
                    <a href="<?= base_url('/homepage') ?>"
                        class="link-offset-2 link-underline link-underline-opacity-0 danger mb-2"> Kembali ke
                        Beranda</a>
                </div>
            </div>
        </div>
